                    ...
                    {tests.length > 0 ? (
                        tests.map((test) => (
                            <div
                                ...
                                className="cursor-pointer bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 transition-transform duration-200 hover:scale-105"
                            >
                        ...
                        <table className="min-w-full table-auto bg-white dark:bg-gray-800">
                            <thead>
                                <tr className="bg-gray-200 dark:bg-gray-700">
                                    <th className="px-6 py-3 text-xs font-medium text-gray-600 dark:text-gray-300 uppercase tracking-wider text-center">
                                        Name
                                    </th>
                                    <th className="px-6 py-3 text-xs font-medium text-gray-600 dark:text-gray-300 uppercase tracking-wider text-center">
                                        Date
                                ...
                                {tests.length > 0 ? (
                                    tests.map((test) => (
                                        <tr
                                            key={test._id}
                                            onClick={() => handleTestClick(test)}
                                            className="cursor-pointer bg-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors duration-200"
                                        >
