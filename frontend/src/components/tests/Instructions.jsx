    ...
    const handleTestClick = async () => {
        try {
            ...
            if (timeValid) {
                ...
                if(submitted)
                navigate(`/dashboard/testlist/${test._id}/attempt`);
            }
        } catch (error) {
        ...
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-8">
                <div className="flex items-center mb-4">
                    ...
                    <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">General Guidelines</h2>
                </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-8">
                <div className="flex items-center mb-4">
                    ...
                    <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">Marks Distribution</h2>
                </div>
                <ol className="list-decimal list-inside text-gray-700 dark:text-gray-300 mb-4">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-8">
                <div className="flex items-center mb-4">
                    ...
                    <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-100 ">Specific Instructions</h2>
                </div>
                <ol className="list-decimal list-inside text-gray-700 dark:text-gray-300 mb-4">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-8">
                ...
                <p className="font-semibold text-gray-900 dark:text-gray-100">ps90798173@gmail.com</p>
            </div>
